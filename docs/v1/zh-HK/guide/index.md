...
以下指南可協助你匯入帳單、管理帳本，以及了解匯率與雲端同步。

- [模板帳單匯入（CSV）](./01-template-bill-import-guide)
- [微信帳單匯入](./02-wechat-bill-import-guide)
- [支付寶帳單匯入](./03-alipay-bill-import-guide)
- [多帳本](./04-multi-ledger-guide)
- [匯率切換](./05-exchange-rate-guide)
