...
<div :class="$style.grid">
  <a :class="$style.card" href="./zh/guide/01-template-bill-import-guide">
    <div :class="$style.title">模板账单导入指南</div>
    <div :class="$style.desc">适用于 CSV 模板文件</div>
  </a>
  <a :class="$style.card" href="./zh/guide/02-wechat-bill-import-guide">
    <div :class="$style.title">微信账单导入教程</div>
    <div :class="$style.desc">支持 CSV / Excel</div>
  </a>
  <a :class="$style.card" href="./zh/guide/03-alipay-bill-import-guide">
    <div :class="$style.title">支付宝账单导入教程</div>
    <div :class="$style.desc">适用于 CSV</div>
  </a>
  <a :class="$style.card" href="./zh/guide/07-pixiu-bill-import-guide">
    <div :class="$style.title">貔貅账单导入指南</div>
    <div :class="$style.desc">适用于 CSV</div>
  </a>
  <a :class="$style.card" href="./zh/guide/08-icost-bill-import-guide">
...
<div :class="$style.grid">
  <a :class="$style.card" href="./zh/faq/">
...
<div :class="$style.grid">
  <a :class="$style.card" href="./zh/help/account-deletion">
    <div :class="$style.title">注销账户说明</div>
    <div :class="$style.desc">注销会清空云端与本机数据</div>
  </a>
  <a :class="$style.card" href="./zh/help/version-history">
