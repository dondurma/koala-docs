...
本《考拉记账用户协议》（以下简称“本协议”）由【应用运营主体名称】及其关联方（以下简称“我们”）与使用 考拉记账（Koala，以下简称“本应用”）的用户（以下简称“你”）共同缔结。

在你开始使用本应用之前，请你务必审慎阅读并充分理解本协议各条款内容。你点击“同意/接受”或以任何方式实际使用本应用服务，即表示你已阅读并同意接受本协议的约束。

## **1. 定义**

​            1.     本应用：指 考拉记账（Koala）客户端软件及其相关服务。
...
​            1.     我们非常重视你的个人信息保护。你在使用本服务时，我们将按照《考拉记账隐私政策》处理你的个人信息。
